...
<head>
	...
	<meta name="keywords" content="BabyShop登录" />
	<meta name="description" content="BabyShop登录" />
...
<body>
					...
					<div class="login_form">
						<form action="user/login" name="loginform"
							...
							<div class="uinArea" id="uinArea">
								<label class="input-tips" for="userId">用户ID：</label>
							...
							<div class="pwdArea" id="pwdArea">
								...
								<div class="inputOuter" id="pArea">
									...
									<input type="password" id="userPassword" name="userPassword" class="inputstyle" />
								</div>
							</div>
			...
			<div class="web_login">
				<form name="form2" id="regUser" accept-charset="utf-8"
					...
					<ul class="reg_form" id="reg-ul">
						...
						<li><label for="userId" class="input-tips2">用户ID：</label>
							<div class="inputOuter2">
								<input type="text" id="userId" name="userId" maxlength="16"
									class="inputstyle2" />
							</div></li>

						<li><label for="userPassword" class="input-tips2">密码：</label>
							<div class="inputOuter2">
								<input type="password" id="userPassword" name="userPassword" maxlength="16"
									class="inputstyle2" />
							</div></li>
						...
						<li><label for="userPhone" class="input-tips2">手机号码：</label>
							<div class="inputOuter2">

								<input type="text" id="userPhone" name="userPhone" maxlength="10"
									class="inputstyle2" />
							</div></li>
	...
	<div class="jianyi">最终解释权归BabyShop所有</div>
</body>
</html>